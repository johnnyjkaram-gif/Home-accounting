...
export async function buildReportTable(householdId: string, type: ReportType, params: { year: number; month: number; from?: Date; to?: Date }) {
  ...
  switch (type) {
    ...
    case 'yearly': {
      ...
      return {
        ...
        summary: [['Total Income', r.totalIncome], ['Total Expenses', r.totalExpenses], ['Net Income', r.netIncome]],
    ...
    case 'expense': {
      ...
      return {
        ...
        summary: [['Total Expenses', r.total]],
        columns: ['Category', 'Amount', 'Transactions'],
        rows: r.categoryBreakdown.map((c) => [c.name, c.amount, c.count]),
      };
    }
    ...
    case 'cashflow': {
      ...
      return {
        ...
        summary: [['Total Income', r.totalIncome], ['Total Expenses', r.totalExpenses], ['Net Cash Flow', r.netIncome]],
